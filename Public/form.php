<?php 
  ...
  include (PRIVATE_PATH . "/DbConnection.php");
?>

<!--  Form Table for Database begins here  -->
<form class="max-w-md mx-auto mt-12 mb-12" method="POST">
